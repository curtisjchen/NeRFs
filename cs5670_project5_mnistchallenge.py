...
Original file is located at
    https://colab.research.google.com/drive/1mqg0VeGXAotFTtelScaRy8xcOQv8b9Rv
...
class StudentModel(nn.Module):
    def __init__(self):
        ...
        self.pool = nn.MaxPool2d(2, 2)
        self.fc1 = nn.Linear(16 * 7 * 7, 59)
        self.bn3 = nn.BatchNorm1d(59)
...
print(f"Model number of parameters: {n_params}")
